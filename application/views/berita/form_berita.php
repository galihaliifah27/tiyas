...
<section class="content-header">
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url(). "berita/insert";?>" method="post">
                <div class="form-group">
                    <label for="judul">Judul</label>
                    <input type="text" name="judul" id="judul" class="form-control" placeholder="judul" require>
            </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="headline" id="headline" class="form-control" placeholder="headline" require>
            </div>
                <div class="form-group">
                    <label for="isi_berita">Isi Berita</label>
                    <textarea name="isi_berita" id="isi_berita" class="form-control summernote" placeholder="isi berita" require></textarea>
            </div>
                <div class="form-group">
